...
public class ChatController {
    ...
    public void sendMessage(
        ...
        // BLOCK CHECK
        // =================================================
        if (userBlockService.isBlockedEither(sender, message.getReceiver())) {
            messagingTemplate.convertAndSendToUser(
                    sender,
                    "/queue/errors",
                    "This user is blocked. Unblock the user to continue chatting."
            );
            return;
        }
        ...
        response.setExpiresAt(savedMessage.getExpiresAt());
     ...
     // =================================================
     // SEND SAME MESSAGE TO SENDER
     // =================================================
     // This is important for disappearing messages.
     // The sender must receive the generated expiresAt
     // from the backend so the timer starts immediately.
